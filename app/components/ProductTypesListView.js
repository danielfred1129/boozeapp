...
import {AsyncStorage, StyleSheet, TouchableHighlight, ListView, Image, View, Text, TouchableOpacity, ScrollView, RecyclerViewBackedScrollView} from 'react-native'
...
class ProductTypesListView extends Component{
	...
	componentDidMount(){
		console.log('ProductTypesListView mounted:');
	...
	componentWillReceiveProps(nextProps){
		...
		console.log('data on componentWillReceiveProps:', data);
