...
import {Modal, TouchableHighlight, StyleSheet, Image, View, Text, TouchableOpacity, TextInput, ScrollView} from 'react-native'
...
class ProductDetailView extends Component{
	...
	render(){
		...
		const instance = this;
		if (rowData.supplier_products.length > 1)
		{
			if (this.state.dropStatus == 'on')
				scroll_height = screen_height - 75 - 45 * rowData.supplier_products.length - 60;
			else 
				scroll_height = screen_height - 75 - 45 - 60;
		}
		else
			scroll_height = screen_height - 75 - 60 - screen_dimensions.STATUS_BAR_HEIGHT;
		...
		return(
			<SideMenu
				...
				<View style={styles.bg}>
					...
					<ScrollView
						style={{flex:1, flexDirection:'column', height:scroll_height}}
						vertical={true}>
