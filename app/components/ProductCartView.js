...
import {Alert, Modal, StyleSheet, ListView, Image, View, Text, TouchableOpacity, TouchableHighlight, TextInput, ScrollView, RecyclerViewBackedScrollView} from 'react-native'
...
class ProductCartView extends Component{
	...
	_onCheckOut(){
		...
		console.log('cartInfo on _onCheckOut of ProductCartView:', cartInfo);
	...
	render() {
		...
		console.log('cartInfo on render of ProductCartView:', cartInfo);
